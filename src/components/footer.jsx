...
import locicon from '../../locicon-removebg-preview.png';
import youtube from '../../youtube-removebg-preview.png';
import instagram from '../../instagram-removebg-preview.png';

const footer = () => {
  return (
    <div className='foot'>
        <img className="footimg" src={perfectlogo} alt="Logo" style={{ width: '100%', height: 'auto', maxWidth: '200px' }} />
        <ul>
        ...
        <div className='contact-info'>
            <img src={locicon} alt="Location" style={{ width: '30px', height: '30px' }} />
            <h4>Opposite of Raddison Blu Resort, Rushikonda, Beach Rd, Yendada, Visakhapatnam, Andhra Pradesh 530045</h4>
        </div>
        <div className='contact'>
            <h3>Our Reach</h3>
            <br></br>
            <img src={youtube} alt="YouTube" style={{ width: '40px', height: '40px', marginRight: '10px' }} />
